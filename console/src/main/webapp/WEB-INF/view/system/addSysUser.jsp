		...
		<div class="page-content">
			<div class="page-bar" style="margin-top: 40px;">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<%=request.getContextPath()%>/system/addSysUser">用户新增</a>
					</li>
				</ul>
			</div>
			<!-- BEGIN FROM -->
					...
					<div class="portlet light bordered">
						<div class="portlet-title">
							<div class="caption font-green-haze">
								...
								<span class="caption-subject bold uppercase">用户新增</span>
							</div>
						</div>
						<div class="portlet-body form">
							<form id="form" role="form" class="form-horizontal" action="<%=request.getContextPath()%>/system/addSysUser" method="POST">
