		...
		<div class="page-content">
			<div class="page-bar" style="margin-top: 40px;">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<%=request.getContextPath()%>/dynamic/addDynamicColumn/${dynamicTableManage.id}">${dynamicTableManage.tableName}表新增列</a>
					</li>
				</ul>
			</div>
			<!-- BEGIN FROM -->
					...
					<div class="portlet light bordered">
						<div class="portlet-title">
							<div class="caption font-green-haze">
								...
								<span class="caption-subject bold uppercase">列新增</span>
							</div>
						</div>
						<div class="portlet-body form">
							<form id="form" role="form" class="form-horizontal" action="<%=request.getContextPath()%>/dynamic/addDynamicColumn" method="POST">
...
function onBack(){
	window.location.href="<%=request.getContextPath()%>/dynamic/dynamicColumnList/${dynamicTableManage.id}";
}
</script>
</html>