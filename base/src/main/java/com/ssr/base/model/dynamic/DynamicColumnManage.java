...
public class DynamicColumnManage {
     ...
     * 字段序号（用于排序显示）
     */
    @Column(name = "field_serial_number")
    private Integer fieldSerialNumber;
	...
	public Integer getFieldSerialNumber() {
		return fieldSerialNumber;
	}

	public void setFieldSerialNumber(Integer fieldSerialNumber) {
